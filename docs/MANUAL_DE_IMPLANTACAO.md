...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **PostgreSQL 16** | `${PREFIXO}_postgres` | `pgvector/pgvector` | `pg16` | **16.14** | Interna (5432) |
| **PgBouncer** | `${PREFIXO}_pgbouncer` | `edoburu/pgbouncer` | `v1.25.2-p0` | **1.25.2-p0** | Interna (6432) / 5432 |
...
| **Caddy WAF** | `${PREFIXO}_caddy` | `caddy` | `2.11.4-alpine` | **2.11.4** | `80` / `443` |
